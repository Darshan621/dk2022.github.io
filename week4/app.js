...
function updateWeatherInfo(data) {
    ...
    <p>The weather in ${data.name} is described as ${weatherDescription}.</p> 
    <p>The temperature is ${mainTemperature} degrees Celsius, with a wind speed of ${windSpeed} meters per second.</p>
`;
